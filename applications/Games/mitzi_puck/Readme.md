...
On the right, the user can track the lives of puck-girl &mdash; initially there are 3 filled hearts which become empty for each death of puck-girl. Underneath, there is a score-tracker.